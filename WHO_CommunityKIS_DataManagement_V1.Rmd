...
This provides steps and code for data cleaning, management, and analysis of __COVID-19 commuunity key informant__ assessment survey. [See here for the questionnare (link forthcoming)](). <span style="color: red;">
(Standard module version as of 1/13/2021) </span>    
...
2. Local macro in __E.1. Country speciic code local__ per section 1 in the questionnaire</span>    
...
surveyid<-451568        #LimeSurvey survey ID
...
dtatempx<-dtatemp%>%select(country, round, month, year, starts_with("z"), starts_with("obs"), starts_with("x"))
```

```{r calculation}
# Among all facilities 
dtasummaryall<-dtatempx%>%
