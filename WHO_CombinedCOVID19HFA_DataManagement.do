...
* Date of last code update: 14 September, 2022
...
*****C.2. Change var names to drop odd elements "y" "sq" - because of Lime survey's naming convention 
	...
	rename (q503*) (q503_0*)
	rename q503_0other q503other /*this is NOT in the paper Q, but added in LS. Can Sorin drop this?*/
	drop q503other
	
	rename q504other q504_008 /*this should have been named as Q504SQ008 in LS. Can Sorin change this?*/
...
* give prefix staff for a number of staff integer variables, which will be used to calculate total
	...
	***** OPT change
		...
		foreach var in $varlist {
			...
			gen `var'_reason_disruption = `var'==1 & (`var'_reason__035==1 | `var'_reason__036==1 | `var'_reason__037==1 ) /*REVISED CODE: 37 added*/			
			}		
