...
<span style="color: red;">__Data managers must check the `submitdate` string values. Then modify format when you convert the string value to numeric, using `as.POSIXct`. See an example below.__ (Revision on 5/19/2022)<span>
```{r duplicates}
# CHECK submitdate 
...
##### E.4. Export clean Respondent-level data for chartbook 
```{r cleandatacsv}
...
##### F.2. Export indicator estimate data for chartbook 
```{r summarydatacsv}
dtasummary<-dtasummary%>%
    mutate(
